    ...
    <div className='bg-[#fafafc]'>
      <div className='fluid-container'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='text-[#666666]'>Thời gian đặt hàng: <span className='text-[#242424]'>{formatDateTime(orderDetail?.data?.item?.createdAt)}</span></div>
        </div>
        ...
        <div className='grid grid-cols-3 gap-10 mt-4'>
          ...
          <div className='p-4 rounded-2xl bg-white'>
            <p className='text-[#1C1C28] font-medium'>{profile?.fullName}</p>
            <p className='text-[#555770] mt-4'>Địa chỉ: <span className='text-[#28293D]'>50 mê trì</span></p>
            <p className='text-[#555770]'>Số điện thoại: <span className='text-[#28293D]'>50 mê trì</span></p>
          </div>
          <div className='p-4 rounded-2xl bg-white'>
            <p className='text-[#1C1C28] font-medium'>{profile?.fullName}</p>
            <p className='text-[#555770] mt-4'>Địa chỉ: <span className='text-[#28293D]'>50 mê trì</span></p>
