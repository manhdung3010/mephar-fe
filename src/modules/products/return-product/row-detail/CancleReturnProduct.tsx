  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-6 text-[#1C1C28]">
        <div className="text-xl font-semibold">Hủy trả hàng</div>
        <div className="h-[1px] w-full bg-[#C7C9D9]" />
        <Image src={BoyImg} alt="" />
        <div className="flex text-lg">
          Bạn có chắc muốn hủy phiếu trả hàng không ?
        </div>
...
export default CancleReturnProduct;
