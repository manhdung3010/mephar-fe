...
export default function CustomPagination({
  ...
  return (
    <PaginationStyled
      className={`flex items-center justify-end gap-x-3  rounded-b-xl bg-white px-6 py-4`}
    >
      <div className="flex items-center gap-x-3">
        ...
        <div>
          <span className="mr-5">kết quả</span> Từ {(page - 1) * pageSize + 1}{' '}
          đến {page * pageSize > total ? total : page * pageSize} trên tổng{' '}
          {total}
        </div>
      </div>
